...
public class P6Core {
  ...
  private static List<ConnectionWrapper> connectionWrappers = new CopyOnWriteArrayList<ConnectionWrapper>();
...
*/
    for( ConnectionWrapper wrapper : P6ModuleManager.getInstance().getConnectionWrappers() ) {
      con = wrapper.wrapConnection(con);
    }
    return con;
  }
